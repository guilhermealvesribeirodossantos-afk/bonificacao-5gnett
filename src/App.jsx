  ...
  useEffect(() => {
    ...
    const aplicarTema = (tema) => {
      ...
      if (btnTema) {
        ...
        btnTema.title = claro ? "Ativar tema escuro" : "Ativar tema claro";
      }
    };

    const temaSalvo = localStorage.getItem("5gnett-tema") || "escuro";
    ...
    return () => {
      if (btnTema) {
        btnTema.removeEventListener("click", alternarTema);
      }
    };
  }, []);
  ...
  return (
    <>
      <div className="app">
        ...
        <main className="main">
          <header className="topbar topbar-corporativa">
            ...
            <div className="usuario usuario-corporativo">
              <div className="avatar">
                <img src={perfil} alt="Perfil" className="usuario-foto" />
              </div>
          ...
          <div id="paginaInicio" className="pagina-app ativa">
            <section className="dashboard-hero">
              <div className="dashboard-hero-copy">
                ...
                <p>
                  Acompanhe a operação da equipe e acesse rapidamente os registros de suporte.
                </p>
              </div>
              <div className="dashboard-hero-actions">
                <div className="data-atual" id="dataAtual">
                  --
                </div>
                <button
            ...
            <section className="dashboard-kpis cards">
              <article className="card kpi-card">
                <div className="kpi-acento kpi-azul">
                </div>
              ...
              <article className="card kpi-card">
                <div className="kpi-acento kpi-verde">
                </div>
                <div className="kpi-conteudo">
                  <span>
                    Resolvidos
              ...
              <article className="card kpi-card">
                <div className="kpi-acento kpi-vermelho">
                </div>
                <div className="kpi-conteudo">
                  <span>
                    Não resolvidos
              ...
              <article className="card kpi-card kpi-destaque">
                <div className="kpi-acento kpi-dourado">
                </div>
                <div className="kpi-conteudo">
                  <span>
                    Resolutividade
              ...
              <article className="workspace-panel">
                ...
                <div className="workspace-actions">
                  <button
                    ...
                    onClick={() =>
                      document.getElementById("btnNovoAtendimento")?.click()} >
          ...
          <div id="paginaAtendimentos" className="pagina-app">
    ...
    <button className="btn-novo" id="btnNovoAtendimento" type="button" > ＋ Novo Atendimento </button>
            ...
            <section className="filtros filtros-operacionais">
              ...
              <button className="btn-filtrar" id="btnFiltrar">
                Filtrar
              </button>
              <button className="btn-limpar" id="btnLimpar">
                Limpar
              </button>
            </section>
          ...
          <div id="paginaEquipe" className="pagina-app pagina-equipe-v1">
            ...
            <section className="equipe-painel-v1">
              <div className="equipe-perfil-head-v1">
                <div className="equipe-foto-v1" id="perfilEquipeAvatar">
                  <img
                    id="perfilEquipeFoto"
                    alt="Foto do atendente"
                    hidden
                    style={{ width: "100%", height: "100%", objectFit: "cover", borderRadius: "50%", display: "none" }} />
                ...
                <div>
                  ...
                  <div className="equipe-foto-acoes-v1" id="equipeFotoAcoes" hidden>
                    <input id="inputFotoEquipe" type="file" accept="image/png,image/jpeg,image/webp" hidden />
                    <button id="btnAlterarFotoEquipe" className="btn-alterar-foto-v1" type="button">
                      Alterar foto
                    </button>
                    <small id="statusFotoEquipe">
                    </small>
                  </div>
                </div>
              ...
              <div className="equipe-progresso-v1">
                ...
                <div className="equipe-trilho-v1">
                  <i id="perfilEquipeProgressoBarra">
                  </i>
                  <em title="Meta: 250 pts">
                  </em>
                </div>
                <footer>
                  <span>
          ...
          <div id="paginaBonificacao" className="pagina-app">
            ...
            <section className="fechamento-mensal-v1">
              ...
              <div className="fechamento-mensal-controles">
                ...
                <div className="fechamento-status-v1" id="fechamentoStatus">
                  <span>
                    STATUS
                  </span>
                  <strong>
            ...
            <section className="ranking-equipe performance-ranking">
              <div className="section-header">
                ...
                <div className="ranking-legenda">
                  <span>
                    <i className="legenda-meta">
                    </i>
                    250 pts Meta individual
                  </span>
                  <span>
                    <i className="legenda-superior">
                    </i>
                    350 pts Faixa individual (+20%)
                  </span>
                </div>
              </div>
              <div className="ranking-grid" id="rankingBonificacao">
          ...
          <div id="paginaRelatorios" className="pagina-app pagina-relatorios-v2">
                ...
                <table className="tabela-relatorio tabela-relatorio-v2">
                  ...
                  <tbody id="tabelaRelatorioAtendentes">
                    <tr>
                      <td
                        colSpan="7"
                        style={{ textAlign: "center", padding: "30px", color: "#69747e" }}
                      >
          ...
          <div id="paginaConfiguracoes" className="pagina-app pagina-config-v2">
      ...
      <div className="modal" id="modalLoginGerencia">
      ...
      <div className="modal" id="modalAtendimento">
      ...
      <div className="modal" id="modalAvaliacao">
      ...
      <div className="modal" id="modalPreviaFechamento">
      ...
      <div className="modal" id="modalHistoricoFechamentos">
        <div className="modal-content modal-historico-fechamentos-v1">
          ...
          <div className="historico-fechamentos-lista-v1" id="historicoFechamentosLista">
      ...
      <div className="modal" id="modalRelato">
